...
import { categoryLabels, categoryIcons, repairStatusLabels } from '@/types/rental';
        ...
        <div className="p-4 border-b">
          <div className="relative">
            ...
            <Input
              ...
              placeholder="חפש לקוחות, מוצרים, השכרות, תיקונים..."
        ...
        <div className="max-h-[400px] overflow-y-auto p-2">
          {!searchTerm.trim() ? (
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm mt-1">חפש בלקוחות, מלאי, השכרות ותיקונים</p>
            </div>
          ) : results.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">
